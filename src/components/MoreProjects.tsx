...
export default function MoreProjects() {
    ...
    return (
        <div className="w-full py-16 bg-stone-950">
            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex justify-center mb-8">
                    ...
                    >
                        ...
                        <svg
                            ...
                            className={`h-5 w-5 transition-transform duration-300 ${open ? 'rotate-180' : 'group-hover:translate-y-0.5'}`}
                            viewBox="0 0 20 20"
                            fill="currentColor"
                        >
                ...
                <div
                    ref={projectsRef}
                    className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 transition-all duration-500 ease-in-out overflow-hidden ${open ? 'max-h-[5000px] opacity-100' : 'max-h-0 opacity-0'
                        }`}
                >
