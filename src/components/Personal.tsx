                ...
                <div className="flex flex-col md:flex-row gap-8 items-center">
                    <section className='w-full md:w-2/6'>
                        <div className="relative group">
                            <div className="absolute w-92 h-92 m-auto -inset-3.5 bg-gradient-to-b from-blue-500 to-purple-500 rounded-lg blur opacity-60 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
                            <img
                                src="../perfil_default.jpg"
                                className="w-80 h-80 m-auto rounded-lg object-cover relative transform transition duration-300"
                                alt="Foto de perfil"
                            />
                        </div>
